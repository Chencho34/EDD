...
public class toolsList {
    	...
    	public static String menuDesplegable() {
    		String valores[] = {"MenuIterativo","MenuRecursivo","Salir"};
    		String res = (String)JOptionPane.showInputDialog(null,"M E N U","Selecciona opcion:",JOptionPane.QUESTION_MESSAGE,null,valores,valores[0]);
    		return(res);
    	}
    	public static String desplegableIterativo() {
    		String valores[] = {"usoDoWhile","usoFor","usoWhile","tablaDeMultiplicar","printArray","sumaDiviciones","decimalOctal","potencias","binarioDecimal","fibonacci","ordenaBurbuja","showArray","factorial","Volver"};
    		String res = (String)JOptionPane.showInputDialog(null,"M E N U","Metodos Iterativos:",JOptionPane.QUESTION_MESSAGE,null,valores,valores[0]);
    		return(res);
    	}
    	public static String desplegableRecursivo() {
    		String valores[] = {"funcionIterativa","funcionIterativa2","funcionIterativa3","tablaDeMultiplicar","printArray","sumaDiviciones","decimalOctal","potencias","binarioDecimal","fibonacci","ordenaBurbuja","showArray","factorial","Volver"};
    		String res = (String)JOptionPane.showInputDialog(null,"M E N U","Metodos Recursivos:",JOptionPane.QUESTION_MESSAGE,null,valores,valores[0]);
    		return(res);
    	}
        
//    	public static String seleccionOpcionIterativo() {
//    		Object valores[]= {"usoDoWhile,usoFor,usoWhile,tablaDeMultiplicar,printArray,sumaDiviciones,decimalOctal,potencias,binarioDecimal,fibonacci,ordenaBurbuja,showArray,factorial"};
//    		String res=(String)JOptionPane.showInputDialog(null,"Menu","Selecciona un objeto:",JOptionPane.QUESTION_MESSAGE,null, valores,valores[0]);
//    	   return (res);
//    	}
