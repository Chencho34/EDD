...
public class App {
    public static void main(String[] args) throws Exception {
        String menu = "Llenar,Imprimir,Vaciar,Burbuja,Shell,SeleccionDirecta" +
                ",InsercionDirecta,Binaria,HeapSort,QuickSortRecursivo,Radix,Intercalacion,Mezcla Directa,Salir";
        menu3(menu);
    }
